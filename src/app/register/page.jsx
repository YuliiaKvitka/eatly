...
import Link from 'next/link'; // Необходимо для навигации
import Image from 'next/image'; // Необходимо для использования изображения
import styles from '../../styles/componentsStyles/SignIn.module.scss';

const Register = () => {
  const [isLoginMode, setIsLoginMode] = useState(false); // По умолчанию это регистрация
      ...
      <form className={styles['auth-form']} onSubmit={handleSubmit}>
        ...
        {isLoginMode && (
          <div className={styles['forgot-password']}>
            <a href="#" onClick={(e) => {
              e.preventDefault();
              // Замените это на функцию, которая обрабатывает забытый пароль
